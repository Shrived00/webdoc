...
export const Navbar = () => {
    ...
    const onDownlaod = (blob: Blob, filename: string) => {
                                    ...
                                    <MenubarSub>
                                        ...
                                        <MenubarSubContent>
                                            ...
                                            <MenubarItem onClick={onSaveHTML} >
                                                <GlobeLockIcon className="size-4 mr-2" />
                                                HTML
                                            </MenubarItem>
